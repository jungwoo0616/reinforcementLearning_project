# -*- coding: utf-8 -*-
# file: soccer_demo_dqn_blue_vs_ppo_orange.py
# 목적: BLUE(b0,b1: DQN) vs ORANGE(o2,o3: PPO) - best 모델 4개를 불러와 시청(watch) 데모 실행
...
BLUE_B0 = os.path.join("..", "DQN", "models_dual_final_blue", "dualdqn_latest.zip")   # DQN BLUE b0
BLUE_B1 = os.path.join("..", "DQN", "models_dual_final_blue", "dualdqn_latest.zip")   # DQN BLUE b1
ORNG_O2 = os.path.join("..", "PPO", "models_dual_final_orange", "dualppo_latest.zip") # PPO ORANGE o2
ORNG_O3 = os.path.join("..", "PPO", "models_dual_final_orange", "dualppo_latest.zip") # PPO ORANGE o3
...
def main():
    ...
    print("[LOAD] ORANGE(PPO) o2:", ORNG_O2)
    print("[LOAD] ORANGE(PPO) o3:", ORNG_O3)

    # BLUE는 DQN, ORANGE는 PPO
    ...
    for t in range(STEPS):
        ...
        if isinstance(action_space, spaces.MultiDiscrete):
            ...
            # PPO: 이미 MultiDiscrete 형식이라고 가정 (학습 시와 동일)
