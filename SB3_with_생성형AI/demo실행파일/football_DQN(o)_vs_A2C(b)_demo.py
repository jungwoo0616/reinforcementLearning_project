# -*- coding: utf-8 -*-
# file: soccer_demo_a2c_vs_dqn.py
# 목적: BLUE(b0,b1: A2C) vs ORANGE(o2,o3: DQN) - best 모델 4개를 불러와 시청(watch) 데모 실행
...
# BLUE 팀 A2C
BLUE_B0 = os.path.join("..", "A2C", "models_dual_final_blue",   "duala2c_latest")      # A2C BLUE b0
BLUE_B1 = os.path.join("..", "A2C", "models_dual_final_blue",   "duala2c_latest")      # A2C BLUE b1
...
def main():
    # 1) 모델 로드
    print("[LOAD] BLUE(A2C) b0:", BLUE_B0)
    print("[LOAD] BLUE(A2C) b1:", BLUE_B1)
    ...
    for t in range(STEPS):
        ...
        # ----- 원시 액션 (모델 출력) -----
        # BLUE: A2C → MultiDiscrete(혹은 Discrete) 그대로 사용
        ...
        if isinstance(action_space, spaces.MultiDiscrete):
            # BLUE(A2C): 이미 MultiDiscrete라고 가정 (학습 시와 동일)
