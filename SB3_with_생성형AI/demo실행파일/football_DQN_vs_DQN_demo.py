# -*- coding: utf-8 -*-
# file: soccer_demo_dqn_vs_dqn.py
# 목적: BLUE(b0,b1: DQN) vs ORANGE(o2,o3: DQN) - best 모델 4개를 불러와 시청(watch) 데모 실행
...
# ORANGE 팀 DQN (오렌지도 DQN으로 학습했다고 가정)
# 오렌지 DQN 모델 저장 위치에 맞게 경로만 바꿔주면 됨
ORNG_O2 = os.path.join("..", "DQN", "models_dual_final_orange", "dualdqn_latest")   # DQN ORANGE o2
ORNG_O3 = os.path.join("..", "DQN", "models_dual_final_orange", "dualdqn_latest")   # DQN ORANGE o3
...
def main():
    ...
    for t in range(STEPS):
        ...
        if isinstance(action_space, spaces.MultiDiscrete):
            # DQN: Discrete -> MultiDiscrete 디코딩 (네 에이전트 모두)
