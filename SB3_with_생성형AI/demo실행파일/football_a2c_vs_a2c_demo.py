# -*- coding: utf-8 -*-
# file: soccer_demo_best_vs_best_a2c.py
# 목적: BLUE(b0,b1) vs ORANGE(o2,o3) - A2C 모델 4개를 불러와 시청(watch) 데모 실행
...
# 필요 시 파일명/경로를 네 환경에 맞게 수정
BLUE_B0 = os.path.join("..", "A2C", "models_dual_final_blue",   "duala2c_latest")
BLUE_B1 = os.path.join("..", "A2C", "models_dual_final_blue",   "duala2c_latest")
ORNG_O2 = os.path.join("..", "A2C", "models_dual_final_orange", "duala2c_latest")
ORNG_O3 = os.path.join("..", "A2C", "models_dual_final_orange", "duala2c_latest")
...
def make_demo_env_with_retries(
    ...
    worker_id=2468,
    time_scale=1.0,
    blue_team_name="BLUE (b0,b1)",
    orange_team_name="ORANGE (o2,o3)",
    max_retries=3,
    timeout_wait=180
):
...
def main():
    # 1) 모델 로드
    print("[LOAD] BLUE b0:", BLUE_B0)
    print("[LOAD] BLUE b1:", BLUE_B1)
    print("[LOAD] ORANGE o2:", ORNG_O2)
    print("[LOAD] ORANGE o3:", ORNG_O3)
