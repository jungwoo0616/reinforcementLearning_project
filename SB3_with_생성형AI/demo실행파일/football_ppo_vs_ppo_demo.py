...
# 목적: BLUE(b0,b1) vs ORANGE(o2,o3) - best 모델 4개를 불러와 시청(watch) 데모 실행
...
BLUE_B0 = os.path.join("..", "PPO", "models_dual_final_blue", "dualppo_latest")
BLUE_B1 = os.path.join("..", "PPO", "models_dual_final_blue", "dualppo_latest")
ORNG_O2 = os.path.join("..", "PPO(vsA2C)", "models_dual_final_orange", "dualppo_latest")
ORNG_O3 = os.path.join("..", "PPO(vsA2C)", "models_dual_final_orange", "dualppo_latest")
...
def with_onehot(x: np.ndarray, which: int):
    # which: 0 -> [1,0], 1 -> [0,1]
    return np.concatenate([x.astype(np.float32, copy=False),
