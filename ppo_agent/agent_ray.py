...
CHECKPOINT_PATH = os.path.join(
    ...
    r"./ray_results(PPO)/PPO_selfplay_twos/PPO_Soccer_d8955_00000_0_2025-11-30_08-33-44\checkpoint_000210/checkpoint-210",
)
...
class RayAgent(AgentInterface):
    def __init__(self, env: gym.Env):
        ...
        if POLICY_NAME not in policy_container:
            raise KeyError(f"Policy '{POLICY_NAME}' not found in checkpoint. Available policies: {list(policy_container.keys())}")
